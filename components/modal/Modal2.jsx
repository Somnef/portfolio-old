...
function Modal2(props) {
    return (
        ...
        >
            ...
            >
                <IoClose className="absolute right-0 mr-4 mt-4 text-2xl text-blue-300 z-[1002] hover:cursor-pointer" onClick={() => props.closeModal()} />
                
                <div className="absolute left-0 w-1/3 h-full bg-black">
                    <img
